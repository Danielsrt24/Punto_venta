    ...
    <div class="container-fluid" style="margin-top: 56px;">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-light" style="min-height: 100vh;">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="<?php echo $base_path; ?>/index.php?page=marcas"><i class="bi bi-bookmark"></i> Marcas</a></li>
            ...
            <main class="col-md-10 ms-sm-auto px-4 py-4">
                <h2><i class="bi bi-plus-circle"></i> Crear Marca</h2>
                ...
                <form method="POST" action="<?php echo $base_path; ?>/index.php?page=marcaController&accion=crear" class="mt-4" style="max-width: 600px;">
                    <div class="mb-3">
                    ...
                    <a href="<?php echo $base_path; ?>/index.php?page=marcas" class="btn btn-secondary">
