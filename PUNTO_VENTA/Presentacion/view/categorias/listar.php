...
$filtro = $_GET['buscar'] ?? '';
$categorias = $categoria_model->readAll($filtro);
        ...
        <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-light" style="min-height: 100vh;">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="<?php echo $base_path; ?>/index.php?page=categorias"><i class="bi bi-tags"></i> Categorías</a></li>
            ...
            <main class="col-md-10 ms-sm-auto px-4 py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <?php if($rol !== 'CAJERO'): ?>
                    <a href="<?php echo $base_path; ?>/index.php?page=categorias&accion=crear" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        <form method="GET" action="<?php echo $base_path; ?>/index.php" class="row g-2">
                            ...
                            <div class="col-md-2 d-grid gap-2">
                                ...
                                <?php if(!empty($filtro)): ?>
                                <a href="<?php echo $base_path; ?>/index.php?page=categorias" class="btn btn-secondary btn-sm"><i class="bi bi-x-circle"></i> Limpiar</a>
                                <?php endif; ?>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo $base_path; ?>/index.php?page=categorias&accion=editar&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning" title="Editar">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <a href="<?php echo $base_path; ?>/index.php?page=categorias&accion=eliminar&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar categoría? Se ocultará de la lista pero permanecerá en la base de datos.')" title="Eliminar">
